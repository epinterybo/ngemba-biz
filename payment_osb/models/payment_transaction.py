...
class TransactionOsb(models.Model):
    ...
    def _osb_get_tx_from_notification_data(self, notification_data):
        ...
        if not reference or not shasign or not status:
            error_msg = 'OSB : received bad data {}'.format(notification_data)
        ...
        if shasign_check.upper() != shasign.upper():
            error_msg = 'OSB: invalid shasign, received {}, computed {}, for data {}'.format(shasign, shasign_check, notification_data)

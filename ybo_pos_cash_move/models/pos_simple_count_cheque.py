...
class PosSimpleCountCheque(models.Model):
    _name = 'ybo_pos_cash_move.pos_simple_count_cheque'
    _description = 'POS Simple Count Cheque'
    ...
    pos_cash_report_id = fields.Many2one('ybo_pos_cash_move.pos_simple_count', string='POS Cash Report', required=True, readonly=True,ondelete='cascade')

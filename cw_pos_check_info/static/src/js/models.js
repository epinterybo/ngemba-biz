...
patch(Payment.prototype, {
    setup(_defaultObj, options) {
        ...
        this.bank_fullname = this.bank_fullname || false;
   },
    getCheckInfo(){
    ...
    set_bank_fullname(bank_fullname){
    ...
    init_from_JSON(json){
        ...
        this.bank_fullname = json.bank_fullname || false;
    },
    export_as_JSON(){
        ...
        json.bank_fullname = this.bank_fullname || false;
        return json;
    },
    export_for_printing() {
        ...
        json.bank_fullname = this.get_bank_fullname();
        return json;
    }
});
